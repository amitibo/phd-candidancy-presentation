...
\begin{frame}{Single-Scattering Model}
  \begin{columns}[C]
    ...
    \item Fast
    \item Analytic
    \item Thin distributions
    \end{itemize}
    \footnotesize{
      Bo Sun at el., 2005\\
      Lucia Florescu at el., 2009\\
      D. Bernabei at el., 2010}
    \column{0.6\textwidth}
...
\begin{frame}{Forward Simulated Models}
  \begin{columns}[C]
    ...
    \item Slow
    \item Not Analytic
    \item Joint work with Vadim Holodovsky
    \end{itemize}
    \footnotesize{
      Hironobu Iwabuchi 2006\\
      Zhen Wang at el., 2012
    }
  \end{columns}
\end{frame}
...
\begin{frame}[label=current]{Optimization}
  \begin{block}{L-BFGS-B}
    \begin{itemize}
    \item Limited Memory Algorithm for Bound Constrained Optimization\\
...
\begin{frame}{Testing Concepts}
  \begin{center}
    \centering
    \only<1>{\includegraphics[width=\textwidth]{images/diagram_simulations1.pdf}}
    \only<2>{\includegraphics[width=\textwidth]{images/diagram_simulations2.pdf}}
    \only<3>{\includegraphics[width=\textwidth]{images/diagram_simulations3.pdf}}
  \end{center}
\end{frame}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\begin{frame}{Simulated Atmospheres}
  \begin{center}
...
\begin{frame}[label=jacobian]{Jacobian (Differentiation)}
  \begin{block}{Jacobian Equation}
    ...
    \end{align*}
  \end{block}
  \hfill\hyperlink{gradient<4>}{\beamerreturnbutton{Return}}
\end{frame}
...
\begin{frame}[label=mask]{Multi-Scattering Mask}
  \only<1>
  {
    \centerline{\def\svgwidth{0.4\linewidth}\footnotesize{\input{images/cross_section_x.pdf_tex}}}
    \captionof{figure}{X Cross Section}
  }
  \only<2>
  {
