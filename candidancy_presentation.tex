...
\begin{frame}[label=current]{Tomography}
  \begin{block}{}
    Reconstruct 3D object from its set of projections    
  \end{block}
\end{frame}

\begin{frame}[label=current]{Attenuation Tomography}
  \begin{columns}
    \column{.5\textwidth}
...
\begin{frame}[label=current]{Emission Tomography}
  \begin{columns}
    \column{.5\textwidth}
    \begin{center}
...
\begin{frame}[label=current]{Optical Tomography}
  \begin{columns}[C]
    \begin{column}{.7\textwidth}
      \begin{itemize}
