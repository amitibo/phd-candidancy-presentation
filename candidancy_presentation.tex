...
%
\includeonlyframes{typical-concentrations}
...
\begin{frame}[label=current]{LIDAR - Light Detection And Ranging}
  \begin{center}
...
\begin{frame}[label=current]{Integral Imaging, Light-Field, Plenoptic}
  \begin{columns}[C]
...
% 
\begin{frame}[label=current]{Attenuation}
...
\begin{frame}[label=current]{Results - Original Atmospheres}
  \begin{center}
...
\begin{frame}[label=aerosols-data]{Aerosols Info}
  %
  % TODO - Add common aerosol sizes and quantities
  %
  \begin{center}
