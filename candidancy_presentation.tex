...
\begin{frame}[label=current]{}
  \centerline{
    \movie[height=8cm, width=12cm, poster, autostart]{Cloud Reconstruction}{clouds.avi}
  }
\end{frame}
...
\begin{frame}[label=current]{Reconstructed Clouds}
  \centerline{\movie[height=7cm, width=12cm, poster, autostart]{Cloud Reconstruction}{cloudsnew.avi}}
\end{frame}
