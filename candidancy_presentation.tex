...
\begin{frame}{Aerosols in the Atmosphere}
  ...
  \end{center}    
  \begin{flushright}
    \only<1-2> {\tiny http://earthobservatory.nasa.gov/Features/Aerosols/}
    \only<3> {\tiny http://calipsooutreach.hamptonu.edu/index.html}
  \end{flushright}
\end{frame}
...
\begin{frame}{Eyjafjallaj\"{o}kull Eruption in 2010}
  ...
  \end{center}
  \begin{flushright}
    \only<1-2> {\tiny http://www.wikipedia.com/}
    \only<3> {\tiny http://www.metrolic.com/eyjafjallajokull-is-dormant...for-the-moment-2042/}
  \end{flushright}
\end{frame}
...
\begin{frame}[label=current]{Remote Sensing}
  \begin{itemize}
  ...
  \begin{center}
    ...
    \includegraphics<2>[width=\columnwidth]{images/misr_od.jpg}
  \end{center}

  \begin{flushright}
    \only<1> {\tiny http://www-misr.jpl.nasa.gov/}
...
\begin{frame}{LIDAR - Light Detection And Ranging}
  \begin{center}
    ...
    \includegraphics<2>[height=7cm]{images/calipso.jpg}
  \end{center}

  \begin{flushright}
    \only<1> {\tiny http://jp.hamamatsu.com/en/rd/technology/energy/lidar.html}
    \only<2> {\tiny http://earthobservatory.nasa.gov/}
  \end{flushright}
\end{frame}
...
\begin{frame}{Scattering}
    ...
    \begin{center}
      \only<3>{\Large Particle Phase Function}
    \end{center}
\end{frame}
...
\begin{frame}{Emission Tomography}
  \begin{center}
    \includegraphics[height=6cm]{images/tomography_emission.jpg}
  \end{center}
  
  \begin{flushright}
    \only{\tiny Gregson at el. \em{Stochastic Tomography and its Applications in 3D Imaging of Mixing Fluids}}
  \end{flushright}
\end{frame}
...
\begin{frame}[label=current]{Prior Knowledge}
...
\begin{frame}[label=current]{Optimization}
  \begin{itemize}
  \item L-BFGS-B
